    ...
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50 cursor-pointer">
      <div className="relative h-64 ">
        <img
          ...
          alt={hero.alias}
          className="object-cover transition-all duration-500 group-hover:scale-110 absolute top-[-30px] w-full h-[390px]"
        />
      ...
      <CardHeader className="py-3 z-10 bg-gray-100/50 backdrop-blur-sm relative top-1 group-hover:top-[-10px] transition-all duration-300">
        <div className="flex justify-between items-start">
          ...
          <Badge
            className={`text-xs  ${hero.category === "Hero" ? "text-green-800 border-green-200 bg-green-100" : "text-red-800 borde-red-200 bg-red-100"} `}
          >
            {hero.category}
          </Badge>
        </div>
